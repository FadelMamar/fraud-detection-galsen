...
outliers_detectors['iforest'] = dict(detector=IForest,
...
outliers_detectors['DIF'] = dict(contamination=_cnt,
                                 detector=DIF,
...
outliers_detectors['abod'] = dict(detector=ABOD,
                                  n_neighbors=[5, 7, 9],
                                  contamination=_cnt,
                                  method=['fast',],
                                  )
...
outliers_detectors['hbos'] = dict(detector=HBOS,
...
outliers_detectors['loda'] = dict(detector=LODA,
                                  n_bins=['auto',10,15,20],
                                  contamination=_cnt,
                                  n_random_cuts=[50,75,100,150],
                                  )

outliers_detectors['knn'] = dict(detector=KNN,
                                  n_neighbors=[3,5,7,9],
                                  contamination=_cnt,
                                  method=['largest'],
                                  radius=[1.0],
...
outliers_detectors['mcd'] = dict(detector=MCD,
                                  assume_centered=[False,True],
                                  contamination=_cnt,
                                  random_state=[41],
                                  )

outliers_detectors['ocsvm'] = dict(detector=OCSVM,
                                   kernel=['rbf','poly'],
                                   tol=[1e-4,],
                                   max_iter=[1000],
                                   gamma=[1e-2,],
...
outliers_detectors['ae1svm'] = dict(detector=AE1SVM,
...
outliers_detectors['vae'] = dict(detector=VAE,
                                 lr=[1e-3,1e-4],
...
outliers_detectors['mo_gaal'] = dict(detector=MO_GAAL,
                                     k=[5,10,20],
                                     momentum=[0.9,],
                                     stop_epochs=[20,],
                                     lr_d=[1e-2],
